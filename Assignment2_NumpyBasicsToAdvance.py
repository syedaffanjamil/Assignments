...
def function12():
    ...
    arr = np.array([1,2,3])
    stack1 = np.stack(((arr,arr,arr)), axis=-1) #write your code here 
    stack2 = np.stack((arr,arr,arr), axis =0)
    
    ans = np.stack((stack1, stack2)).reshape(1,18) 
...
def function19():
    ...
    output = np.multiply(X,W) + b   # Write your code here
...
def fucntion20():
    ...
    return np.apply_along_axis(xyz, 0, x) #Write your Code here
